...
This project is an AI-assisted clinical decision support system developed for automated brain stroke classification using CT/MRI medical images. The system detects and classifies brain scans into:

Normal
Ischemic Stroke
Hemorrhagic Stroke

The platform integrates Deep Learning, Explainable AI (XAI), and an interactive web interface to assist healthcare professionals in faster and more interpretable diagnosis.
